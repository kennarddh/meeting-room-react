		...
		plugins: [
			...
			VitePWA({
				...
				includeAssets: [
					...
					`${base}/Icons/apple-touch-icon114x114.png`,
					`${base}/Icons/apple-touch-icon72x72.png`,
					`${base}/Icons/apple-touch-icon144x144.png`,
					`${base}/Icons/apple-touch-icon60x60.png`,
					`${base}/Icons/apple-touch-icon120x120.png`,
					...
					`${base}/Icons/favicon-128.png`,
					`${base}/Icons/favicon-196x196.png`,
					`${base}/Icons/favicon-96x96.png`,
					`${base}/Icons/favicon-32x32.png`,
					`${base}/Icons/favicon-16x16.png`,
					`${base}/Icons/favicon-128.png`,
					`${base}/Icons/Maskable/maskable_icon_x48.png`,
					`${base}/Icons/Maskable/maskable_icon_x72.png`,
					`${base}/Icons/Maskable/maskable_icon_x96.png`,
					`${base}/Icons/Maskable/maskable_icon_x128.png`,
					`${base}/Icons/Maskable/maskable_icon_x192.png`,
					`${base}/Icons/Maskable/maskable_icon_x375.png`,
				],
				manifest: {
